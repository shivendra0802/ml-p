...
class Preprocessor:
    ...
    def impute_missing_values(self, data, cols_with_missing_values):
        ...
        self.data=data
        self.cols_missing_values = cols_missing_values
        try:
            self.imputer = CategoricalImputer()
            for col in self.cols_missing_values:
    ...
    def scale_numerical_columns(self,data):
        ...
        self.data=data 
        try:
            self.num_df = self.data.dtypes(include=['int64']).copy()
    ...
    def encode_categorical_columns(self,data):
        ...
        self.data = data
        try:
            self.cat_df = self.data.dtypes(include=['object']).copy()
